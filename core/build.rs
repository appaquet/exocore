    ...
    if env::var("GENERATE_PROTOS").is_ok() {
...

        {
            ...
            config
                ...
                .field_attribute("LocalNodeConfig.store.index", "#[serde(default)]")
                .field_attribute("LocalNodeConfig.store.index.pending_index_config", "#[serde(default)]")
                .field_attribute("LocalNodeConfig.store.index.chain_index_config", "#[serde(default)]")
