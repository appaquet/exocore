...
mod tests {
    ...
    #[test]
    fn can_build_and_read_sized_inner() -> Result<(), anyhow::Error> {
    ...
    #[test]
    fn can_build_and_read_unsized_inner() -> Result<(), anyhow::Error> {
    ...
    #[test]
    fn frame_iterator() -> Result<(), anyhow::Error> {
        let buffer = {
            let buffer = Vec::new();
    ...
    #[test]
    fn from_next_offset() -> Result<(), anyhow::Error> {
        let buffer = {
            let buffer = Vec::new();
            let mut buffer_cursor = Cursor::new(buffer);
    ...
    #[test]
    fn invalid_from_next_offset() -> Result<(), anyhow::Error> {
        let frame1 = SizedFrameBuilder::new(vec![1u8; 10]);
