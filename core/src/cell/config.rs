...
mod tests {
    ...
    #[test]
    fn parse_node_config_yaml_ser_deser() -> Result<(), anyhow::Error> {
    ...
    #[test]
    fn parse_node_config_example_yaml_file() -> Result<(), anyhow::Error> {
    ...
    #[test]
    pub fn parse_node_config_from_yaml() -> Result<(), anyhow::Error> {
        let yaml = r#"
name: node name
...
"#;
    ...
    #[test]
    pub fn parse_node_optional_fields_yaml() -> Result<(), anyhow::Error> {
        let yaml = r#"
keypair: ae2oiM2PYznyfqEMPraKbpAuA8LWVhPUiUTgdwjvnwbDjnz9W9FAiE9431NtVjfBaX44nPPoNR8Mv6iYcJdqSfp8eZ
public_key: peFdPsQsdqzT2H6cPd3WdU1fGdATDmavh4C17VWWacZTMP
