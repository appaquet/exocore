...
#[test]
fn should_propose_block_on_new_operations() -> Result<(), anyhow::Error> {
...
#[test]
fn should_not_propose_block_if_not_data() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
...
#[test]
fn only_one_node_at_time_should_commit() -> Result<(), anyhow::Error> {
...
#[test]
fn commit_block_at_interval() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
...
#[test]
fn commit_block_after_maximum_operations() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.clocks[0].set_fixed_instant(Instant::now());
...
#[test]
fn update_pending_status_for_committed_operations() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.clocks[0].set_fixed_instant(Instant::now());
...
#[test]
fn should_sign_valid_proposed_block() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.chain_add_genesis_block(0);
    cluster.tick_chain_synchronizer(0)?;
...
#[test]
fn should_order_next_best_blocks() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.chain_add_genesis_block(0);
    cluster.tick_chain_synchronizer(0)?;
...
#[test]
fn should_refuse_invalid_proposed_block() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.chain_add_genesis_block(0);
    cluster.tick_chain_synchronizer(0)?;
...
#[test]
fn proposal_should_expire_after_timeout() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
...
#[test]
fn test_is_node_commit_turn() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn cleanup_past_committed_operations() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.clocks[0].set_fixed_instant(Instant::now());
...
#[test]
fn dont_cleanup_operations_from_commit_refused_blocks() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
...
#[test]
fn cleanup_dangling_operations() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(1);
    cluster.clocks[0].set_fixed_instant(Instant::now());
