...
#[test]
fn handle_sync_response_blocks() -> Result<(), anyhow::Error> {
...
#[test]
fn sync_empty_node1_to_full_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn sync_full_node1_to_empty_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn sync_full_node1_to_half_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
    cluster.chain_generate_dummy(0, 100, 3434);
...
#[test]
fn sync_half_node1_to_full_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn sync_fully_divergent_node1_to_full_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn sync_single_block_even_if_max_out_size() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn cannot_sync_all_divergent() -> Result<(), anyhow::Error> {
...
#[test]
fn sync_half_divergent_node1_to_full_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
    cluster.chain_generate_dummy(0, 100, 1234);
...
#[test]
fn sync_empty_node1_to_big_chain_node2() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
...
#[test]
fn leader_lost_metadata_out_of_date() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(4);
    cluster.chain_generate_dummy(0, 50, 3434);
    cluster.chain_generate_dummy(1, 100, 3434);
...
#[test]
fn leader_lost_chain_too_far() -> Result<(), anyhow::Error> {
    let mut cluster = EngineTestCluster::new(2);
    cluster.chain_generate_dummy(0, 50, 3434);
    cluster.chain_generate_dummy(1, 100, 3434);
...
#[test]
fn quorum_lost_and_regain() -> Result<(), anyhow::Error> {
