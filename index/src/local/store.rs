...
pub mod tests {
    ...
    #[test]
    fn store_mutate_query_via_handle() -> Result<(), anyhow::Error> {
    ...
    #[test]
    fn store_mutate_return_entities() -> Result<(), anyhow::Error> {
        let mut test_store = TestStore::new()?;
        test_store.start_store()?;
    ...
    #[test]
    fn query_error_propagating() -> Result<(), anyhow::Error> {
        let mut test_store = TestStore::new()?;
        test_store.start_store()?;
    ...
    #[test]
    fn mutation_error_propagating() -> Result<(), anyhow::Error> {
        let mut test_store = TestStore::new()?;
        test_store.start_store()?;
    ...
    #[test]
    fn watched_query_failure() -> Result<(), anyhow::Error> {
        let mut test_store = TestStore::new()?;
        test_store.start_store()?;
