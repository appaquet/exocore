...
#[test]
fn index_full_pending_to_chain() -> Result<(), anyhow::Error> {
...
#[test]
fn reopen_chain_index() -> Result<(), anyhow::Error> {
    let config = EntityIndexConfig {
...
#[test]
fn reopen_chain_and_pending_transition() -> Result<(), anyhow::Error> {
    let config = EntityIndexConfig {
...
#[test]
fn reindex_pending_on_discontinuity() -> Result<(), anyhow::Error> {
...
#[test]
fn chain_divergence() -> Result<(), anyhow::Error> {
    let config = EntityIndexConfig {
        chain_index_min_depth: 0, // index as soon as new block appear
        ..TestEntityIndex::create_test_config()
    };
...
#[test]
fn delete_entity_trait() -> Result<(), anyhow::Error> {
    let config = EntityIndexConfig {
...
#[test]
fn delete_all_entity_traits() -> Result<(), anyhow::Error> {
...
#[test]
fn delete_entity() -> Result<(), anyhow::Error> {
    let config = EntityIndexConfig {
        chain_index_min_depth: 1, // index in chain as soon as another block is after
        ..TestEntityIndex::create_test_config()
    };
...
#[test]
fn traits_compaction() -> Result<(), anyhow::Error> {
    let config = EntityIndexConfig {
        chain_index_min_depth: 1, // index in chain as soon as another block is after
        ..TestEntityIndex::create_test_config()
    };
...
#[test]
fn query_paging() -> Result<(), anyhow::Error> {
    let config = TestEntityIndex::create_test_config();
    let mut test_index = TestEntityIndex::new_with_config(config)?;
...
#[test]
fn query_multiple_mutations_paging() -> Result<(), anyhow::Error> {
    let config = TestEntityIndex::create_test_config();
    let mut test_index = TestEntityIndex::new_with_config(config)?;
...
#[test]
fn query_ordering() -> Result<(), anyhow::Error> {
    let config = TestEntityIndex::create_test_config();
    let mut test_index = TestEntityIndex::new_with_config(config)?;
...
#[test]
fn summary_query() -> Result<(), anyhow::Error> {
    let config = TestEntityIndex::create_test_config();
    let mut test_index = TestEntityIndex::new_with_config(config)?;
