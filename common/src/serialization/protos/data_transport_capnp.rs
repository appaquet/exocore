...
pub mod envelope {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_from<'b>(&mut self, value: crate::common_capnp::node::Reader<'b>) -> ::capnp::Result<()> {
...
pub mod pending_sync_request {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_ranges(&mut self, value: ::capnp::struct_list::Reader<'a,crate::data_transport_capnp::pending_sync_range::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
    }
    #[inline]
...
pub mod pending_sync_range {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_requested_details(self) -> ::std::result::Result<crate::data_transport_capnp::pending_sync_range::RequestedDetails,::capnp::NotInSchema> {
    ...
    #[inline]
    pub fn get_operations(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::data_chain_capnp::pending_operation::Owned>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_requested_details(&mut self, value: crate::data_transport_capnp::pending_sync_range::RequestedDetails)  {
    ...
    #[inline]
    pub fn get_operations(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::data_chain_capnp::pending_operation::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1))
    }
    #[inline]
    pub fn set_operations(&mut self, value: ::capnp::struct_list::Reader<'a,crate::data_chain_capnp::pending_operation::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_operations(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::data_chain_capnp::pending_operation::Owned> {
  ...
  impl ::capnp::traits::HasTypeId for RequestedDetails {
    #[inline]
    fn type_id() -> u64 { 0xffd6_b306_ea5b_ff2du64 }
  }
}
